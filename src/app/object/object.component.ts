...
export class ObjectComponent implements OnInit {
  ...
  getResult(){
      ...
      this.makeBrand()
      let reqUrl = 'https://rest.viglink.com/api/product/search?apiKey=645728cd6d815e3890d53f3b16f562cd&query='+this.firstNameCompany+'&merchant[]=Amazon%20Marketplace&filterImages=false'
